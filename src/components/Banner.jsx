  ...
  return (
    ...
    <div className="h-[250px] md:h-[370px] flex flex-col justify-center items-center gap-10 text-center">
        ...
        <div className="border bg-white w-[300px] md:w-[400px] rounded-md pl-3 flex"> 
            <input type="text" placeholder="Search here... " className="outline-none border-none w-full"/>
            <button className="bg-red-500 text-gray-50 font-semibold py-2 px-4 rounded-r-md hover:bg-red-600"> Search </button>
        </div>
